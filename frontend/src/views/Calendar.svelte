...
<div class="calendar-container p-4">
    ...
    {:else}
        <div bind:this={calendarEl} class="border p-4 bg-white rounded shadow min-h-[500px]">
            <p class="text-gray-500 italic">FullCalendar will render here. ({events.length} events loaded)</p>
        </div>
    {/if}
</div>
